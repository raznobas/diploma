            ...
            <form @submit.prevent="submit">
                <div class="grid grid-cols-4 md:grid-cols-4 lg:grid-cols-8 gap-2 items-end">
                    ...
                    <div class="flex flex-col max-sm:col-span-2">
                        ...
                        <InputMask id="phone" inputmode="numeric" :unmask="false" v-model="form.phone" mask="+7 (999) 999-99-99" placeholder="+7" class="mt-1 p-1 border border-gray-300 rounded-md" fluid />
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Место работы</th>
                    ...
                    <tr v-for="client in clients.data" :key="client.id">
                        ...
                        <td class="px-3 py-2 whitespace-nowrap">{{ client.workplace }}</td>
                        <td class="px-3 py-2 whitespace-nowrap">
